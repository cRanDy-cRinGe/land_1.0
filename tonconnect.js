document.addEventListener('DOMContentLoaded', function () {
    ...
    console.log(TonConnect); // Перевіряє, чи TonConnect доступний

    const tonConnect = new TonConnect({ manifestUrl: 'https://crandy-cringe.github.io/land_1.0/tonconnect-manifest.json' });
